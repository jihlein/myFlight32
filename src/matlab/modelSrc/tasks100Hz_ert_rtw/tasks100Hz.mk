...
## Generated on : Mon Sep 22 19:36:43 2014
## MATLAB Coder version: 2.6 (R2014a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/tasks100Hz.exe
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = tasks100Hz_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = tasks100Hz_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/tasks100Hz.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR)/tasks100Hz_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=tasks100Hz -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/tasks100Hz_ert_rtw/tasks100Hz.c

MAIN_SRC = $(START_DIR)/tasks100Hz_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/tasks100Hz_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" "$<"
