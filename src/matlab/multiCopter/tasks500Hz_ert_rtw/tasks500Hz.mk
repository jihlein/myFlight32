...
## Generated on : Fri Dec 19 10:58:50 2014
## MATLAB Coder version: 2.6 (R2014a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/tasks500Hz.exe
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = tasks500Hz_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = tasks500Hz_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/tasks500Hz.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR)/tasks500Hz_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=tasks500Hz -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/tasks500Hz_ert_rtw/tasks500Hz.c

MAIN_SRC = $(START_DIR)/tasks500Hz_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/tasks500Hz_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" "$<"
