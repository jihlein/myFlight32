...
#define SLAVE_SPEKTRUM_UART_PIN        GPIO_Pin_11       // Dummy value for F3 Naze32 hardware
#define SLAVE_SPEKTRUM_UART_GPIO       GPIOB             // Dummy value for F3 Naze32 hardware
#define SLAVE_SPEKTRUM_UART_PINSOURCE  GPIO_PinSource11  // Dummy value for F3 Naze32 hardware

#define MASTER_BIND_COUNT   5
#define SLAVE_BIND_COUNT    6

#define SPEKTRUM_BIND_PIN   GPIO_Pin_8
...
static inline void spektrumParser(uint8_t c, spektrumStateType* spektrumState, bool slaveReceiver)
{
    ...
    // If we have just started the re-sync process or
    // if we have received a character before our
...
///////////////////////////////////////////////////////////////////////////////
// Timer 17 Interrupt Handler - Updates times used by Spektrum Parser
///////////////////////////////////////////////////////////////////////////////
...
void spektrumInit(void)
{
    ...
    TIM_TimeBaseStructure.TIM_Prescaler         = 72 - 1;              // 72 MHz / 72 = 1 MHz = 1 uSec Tick
    ...
    GPIO_PinAFConfig(MASTER_SPEKTRUM_UART_GPIO, MASTER_SPEKTRUM_UART_PINSOURCE, GPIO_AF_7);
    ...
    if ((eepromConfig.slaveSpektrum == true) && false)  // HJI Inhibit Slave Spektrum on Naze32 Pro
    {
        ...
        GPIO_PinAFConfig(SLAVE_SPEKTRUM_UART_GPIO, SLAVE_SPEKTRUM_UART_PINSOURCE, GPIO_AF_7);
...
void checkSpektrumBind(void)
{
    ...
    // Configure Primary UART pin as output
    GPIO_InitStructure.GPIO_Pin   = MASTER_SPEKTRUM_UART_PIN;
  ...
  //GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
    ...
    GPIO_SetBits(MASTER_SPEKTRUM_UART_GPIO, MASTER_SPEKTRUM_UART_PIN);
    ...
    {
    	GPIO_ResetBits(MASTER_SPEKTRUM_UART_GPIO, MASTER_SPEKTRUM_UART_PIN);
