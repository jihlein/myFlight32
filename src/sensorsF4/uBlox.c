...
static uint8_t ubloxInitData[] = {0xB5,0x62,            // Header             Turn Off NMEA GGA Msg
                                  ...
                                  /* HJI 0xB5,0x62,            // Header             Turn on Precise Point Positioning
                                  0x06,0x23,            // ID
                                  0x28,0x00,            // Length
                                  0x00,0x00,            // version
                                  0x00,0x20,            // mask1              (Mask to apply PPP flag)
                                  0x00,0x00,0x00,0x00,  // Reserved0
                                  0x00,                 // Reserved1
                                  0x00,                 // Reserved2
                                  0x00,                 // minSVs             (Not enabled in mask, keep default value)
                                  0x00,                 // maxSVs             (Not enabled in mask, keep default value)
                                  0x00,                 // minCNO             (Not enabled in mask, keep default value)
                                  0x00,                 // Reserved5
                                  0x00,                 // iniFix3D           (Not enabled in mask, keep default value)
                                  0x00,                 // Reserved6
                                  0x00,                 // Reserved7
                                  0x00,                 // Reserved8
                                  0x00,0x00,            // wknRollover       (Not enabled in mask, keep default value)
                                  0x00,                 // Reserved9
                                  0x00,                 // Reserved10
                                  0x00,0x00,0x00,0x00,  // Reserved11
                                  0x01,                 // usePPP
                                  0x00,                 // useAOP             (Not enabled in mask, keep default value)
                                  0x00,                 // Reserved12
                                  0x00,                 // Reserved13
                                  0x00,0x00,            // aopOrbMaxErr       (Not enabled in mask, keep default value)
...
void ubloxParseData(void)
{
    ...
    if (ubloxClass == 1)         // NAV
    {
        ...
        {
    		sensors.gps.iTOW      = ubloxMessage.nav_timeutc.iTOW;
    		sensors.gps.latitude  = ubloxMessage.nav_posllh.lat;
        	sensors.gps.longitude = ubloxMessage.nav_posllh.lon;
        	sensors.gps.height    = ubloxMessage.nav_posllh.height;
        	sensors.gps.hMSL      = ubloxMessage.nav_posllh.hMSL;
        }
        ...
        {
    		sensors.gps.iTOW        = ubloxMessage.nav_timeutc.iTOW;
    		sensors.gps.fix         = ubloxMessage.nav_status.gpsFix;
            sensors.gps.statusFlags = ubloxMessage.nav_status.flags;
        }
        ...
        {
    		sensors.gps.iTOW = ubloxMessage.nav_timeutc.iTOW;
    		sensors.gps.hDop = ubloxMessage.nav_dop.hDOP;
    		sensors.gps.vDop = ubloxMessage.nav_dop.vDOP;
		}
        ...
        {
    		sensors.gps.iTOW    = ubloxMessage.nav_timeutc.iTOW;
    		sensors.gps.numSats = ubloxMessage.nav_sol.numSV;
        }
        ...
        {
    		sensors.gps.iTOW    = ubloxMessage.nav_timeutc.iTOW;
    		sensors.gps.velN    = ubloxMessage.nav_velned.velN;
    		sensors.gps.velE    = ubloxMessage.nav_velned.velE;
    	    sensors.gps.velD    = ubloxMessage.nav_velned.velD;
    	    sensors.gps.speed   = ubloxMessage.nav_velned.speed;
    	    sensors.gps.gSpeed  = ubloxMessage.nav_velned.gSpeed;
    	    sensors.gps.heading = ubloxMessage.nav_velned.heading;
        }
        ...
        {
    		sensors.gps.iTOW  = ubloxMessage.nav_timeutc.iTOW;
    		sensors.gps.year  = ubloxMessage.nav_timeutc.year;
    		sensors.gps.month = ubloxMessage.nav_timeutc.month;
            sensors.gps.day   = ubloxMessage.nav_timeutc.day;
		}
    	...
    	{
    		sensors.gps.iTOW  = ubloxMessage.nav_timeutc.iTOW;
    		sensors.gps.numCh = ubloxMessage.nav_svinfo.numCh;

			for (n = 0; n < sensors.gps.numCh; n++)
			{
				sensors.gps.chn[n]  = ubloxMessage.nav_svinfo.svinfo[0 + 12 * n];
				sensors.gps.svid[n] = ubloxMessage.nav_svinfo.svinfo[1 + 12 * n];
				sensors.gps.cno[n]  = ubloxMessage.nav_svinfo.svinfo[4 + 12 * n];
			}
		}
