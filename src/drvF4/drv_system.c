...
void SysTick_Handler(void)
{
...

    {
        ...
        accelSum100HzMXR[XAXIS] += mxr9150XAxis();
		accelSum100HzMXR[YAXIS] += mxr9150YAxis();
		accelSum100HzMXR[ZAXIS] += mxr9150ZAxis();
...
void systemInit(void)
{
    ...
    cliPortPrintF("\nMY FLIGHT 32 (AQ32) Firmware V%s, Build Date " __DATE__ " "__TIME__" \n", __MYFLIGHT32_VERSION);
