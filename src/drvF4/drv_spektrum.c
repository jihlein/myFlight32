...
#define MASTER_SPEKTRUM_UART_PIN       GPIO_Pin_7
#define MASTER_SPEKTRUM_UART_GPIO      GPIOC
#define MASTER_SPEKTRUM_UART_PINSOURCE GPIO_PinSource7

#define SLAVE_SPEKTRUM_UART_PIN        GPIO_Pin_1
#define SLAVE_SPEKTRUM_UART_GPIO       GPIOA
#define SLAVE_SPEKTRUM_UART_PINSOURCE  GPIO_PinSource1
...
void spektrumInit(void)
{
    ...
    GPIO_PinAFConfig(MASTER_SPEKTRUM_UART_GPIO, MASTER_SPEKTRUM_UART_PINSOURCE, GPIO_AF_USART6);
